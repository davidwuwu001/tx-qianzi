  ...
  const handleNext = async () => {
    try {
      if (currentStep === 0) {
        ...
        await form.validateFields(['partyBName', 'partyBPhone', 'partyBIdCard']);
        handleSubmit();
      }
    } catch {
      // 验证失败
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Form form={form} layout="vertical" className="px-4">
        ...
        {currentStep === 1 && (
          <Card className="rounded-xl">
            <h3 className="text-base font-medium mb-4">乙方信息</h3>
            ...
            >
              <Input placeholder="请输入乙方姓名" size="large" />
            </Form.Item>
            ...
            >
              <Input placeholder="请输入身份证号（选填）" size="large" maxLength={18} />
            </Form.Item>
          </Card>
        )}
        ...
        {currentStep === 2 && result && (
          <div className="space-y-4">
            ...
            <Card className="rounded-xl">
              <h4 className="font-medium mb-2">乙方信息</h4>
